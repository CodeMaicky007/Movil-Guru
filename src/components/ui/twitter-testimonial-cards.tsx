  ...
  return (
    ...
    >
      <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
        <div className="size-9 sm:size-12 rounded-full bg-gradient-to-br from-[#0038FF] via-blue-400 to-[#CCFF00] flex items-center justify-center overflow-hidden shrink-0">
          {avatar ? (
