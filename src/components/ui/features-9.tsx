            ...
            <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
                <div>
                    <div className="p-6 sm:p-12">
                        ...
                        <p className="mt-8 text-2xl font-semibold">Red de talleres conectada. Tu reparación, siempre localizada.</p>
                    </div>
                    ...
                    <div aria-hidden className="relative">
                        <div className="absolute inset-0 z-10 m-auto size-fit">
                            <div className="rounded-[--radius] bg-background z-[1] dark:bg-muted relative flex size-fit w-fit items-center gap-2 border px-3 py-1 text-xs font-medium shadow-md shadow-black/5">
                                <span className="text-lg">🇪🇸</span> Última recogida en Madrid
                            </div>
                ...
                <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l dark:bg-transparent">
                    <div className="relative z-10">
                        <span className="text-muted-foreground flex items-center gap-2">
                            ...
                            Soporte por email y web
                        </span>

                        <p className="my-8 text-2xl font-semibold">Resolvemos tus dudas por email o chat, antes y después de la reparación.</p>
                    </div>
                    <div aria-hidden className="flex flex-col gap-8">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-muted-foreground text-xs">Sáb 22 Feb</span>
                            </div>
                            <div className="rounded-[--radius] bg-background mt-1.5 w-3/5 border p-3 text-xs">Hola, mi pantalla no responde al tacto.</div>
                        </div>

                        <div>
                            <div className="rounded-[--radius] mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">Lo revisamos en 47 minutos. Garantía de por vida incluida y piezas originales certificadas.</div>
                ...
                <div className="relative col-span-full">
                    <div className="absolute z-10 max-w-lg px-6 pr-12 pt-6 md:px-12 md:pt-12">
                        ...
                        <p className="my-8 text-2xl font-semibold">
                            Monitoriza el flujo de reparaciones en tiempo real. <span className="text-muted-foreground"> Identifica y resuelve incidencias al instante.</span>
                        </p>
                    </div>
                    <MonitoringChart />
                </div>
