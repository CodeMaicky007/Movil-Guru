    ...
    <section className="py-20 md:py-28 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-12">
          <div>
            <div className="inline-block bg-[#0038FF]/10 text-[#0038FF] border border-[#0038FF]/20 text-xs font-black px-3 py-1 rounded-full mb-4 uppercase tracking-wider">
              Nuestros Servicios
            </div>
            <h2
              className="text-3xl md:text-5xl font-black text-black leading-tight max-w-lg"
              style={{ fontFamily: "var(--font-display, inherit)" }}
            >
              {heading}
            </h2>
            <p className="text-black/45 mt-3 text-sm md:text-base font-medium max-w-md">
              {subheading}
            </p>
          </div>
          <a
