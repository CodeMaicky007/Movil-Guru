...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (email === "erik@gmail.com" && password === "1234") alert("¡Bienvenido, Erik!");
    else setError("Correo o contraseña incorrectos. Inténtalo de nuevo.");
    setIsLoading(false);
  };
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 font-sans">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-[#060d12] p-12 overflow-hidden">
        ...
        {/* Characters – 25% bigger than before */}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <label className="block">
                ...
                <div className="mt-2 group relative flex items-center rounded-2xl border border-white/[0.08] bg-white/[0.03] px-4 focus-within:border-[#CCFF00]/50 focus-within:bg-white/[0.05] transition-colors">
                  ...
                  <input type="email" value={email} autoComplete="off" onChange={e => setEmail(e.target.value)} onFocus={() => setIsTyping(true)} onBlur={() => setIsTyping(false)} required placeholder="tu@correo.com"
              ...
              {error && <div className="p-3 text-xs text-red-400 bg-red-950/20 border border-red-900/30 rounded-xl">{error}</div>}
