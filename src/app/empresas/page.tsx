        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-28 md:pt-28 md:pb-36">
          ...
          <div className="flex flex-col gap-1 md:gap-2">
            <motion.h1
              ...
              className="text-[clamp(2rem,6vw,72px)] font-black leading-[0.82] tracking-tighter uppercase text-[#CCFF00] m-0"
              style={{
            ...
            <motion.h1
              ...
              className="text-[clamp(2rem,6vw,72px)] font-black leading-[0.82] tracking-tighter uppercase text-white m-0 pl-[8%]"
              style={{
                fontFamily: 'var(--font-display), sans-serif',
                textShadow: "2px 2px 0 #001A99,4px 4px 0 #001A99,6px 6px 0 #001A99",
              }}
